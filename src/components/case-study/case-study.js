    ...
    <Container className='case-study'>
      ...
      <Row className='justify-content-center pt-2 pb-4'>
        <Column sm='4' md='3' className='text-center'>
          <Button variant='outline-secondary' href='https://ettasmoviedatabase.netlify.app/' className='m-2'>Check out EMDB</Button>
        </Column>
        <Column sm='4' md='3' className='text-center'>
          <Button variant='outline-secondary' href='https://github.com/ettariley/EMDB' className='m-2'>Server-Side Code</Button>
        </Column>
        <Column sm='4' md='3' className='text-center'>
          <Button variant='outline-secondary' href='https://github.com/ettariley/EMDB-client' className='m-2'>Client-Side Code</Button>
        </Column>
      </Row>
